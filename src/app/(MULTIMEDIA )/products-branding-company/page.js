...
import { HeroData,MainBannerData,Faq,ThreeCardLeftData,UpperThreeCardRightDatas,DownThreeCardRightDAta} from "@/data/Multimedia/products-branding-companyData"
import { TestimonialsPBCData } from "@/data/TestimonialsDataa"
import { CBMeta } from "@/data/metaTags/metaData"
...
<SatisfiedNewuser items={SatisFiedData}/>
        ...
        <Testimonial items={TestimonialsPBCData} />
