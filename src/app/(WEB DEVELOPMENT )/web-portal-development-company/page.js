...
import { TestimonialsWPDData } from "@/data/TestimonialsDataa";
...
} from "@/data/WebDevelopment/web-portal-development-companyData";
...
const EWD = () => {
  return (
    ...
    <Layout>
      ...
      <Testimonial items={TestimonialsWPDData} />
