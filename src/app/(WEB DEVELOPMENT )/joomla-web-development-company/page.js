...
import { TestimonialsJWDData } from "@/data/TestimonialsDataa";
...
} from "@/data/WebDevelopment/joomla-web-development-companyData";
...
const EWD = () => {
  return (
    ...
    <Layout>
      ...
      <Testimonial items={TestimonialsJWDData} />
